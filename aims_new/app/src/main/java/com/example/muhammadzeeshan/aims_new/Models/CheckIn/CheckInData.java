...
public class CheckInData {
    ...
    public CheckInData(String template_Id, String asset_Id, String widget_Id, String widget_Data) {
    ...
    public CheckInData(String template_Id, String asset_Id, String widget_Data) {
        Template_Id = template_Id;
        Asset_Id = asset_Id;
        Widget_Data = widget_Data;
    }
