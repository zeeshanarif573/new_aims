...
public class TemplateDescription {
    ...
    public TemplateDescription(String template_id, String template_name, String template_description) {
    ...
    public TemplateDescription(String template_name, String template_description) {
        this.template_name = template_name;
        this.template_description = template_description;
    }
